...
def highlite(color_hex: str, style: str = ''):
...
STYLES = {
    'keyword': highlite('e39e44'),
    'operator': highlite('e35744'),
    'brace': highlite('d1d1d1'),
    'defclass': highlite('e3bb44', 'bold'),
    'string': highlite('a4c73c'),
    'docstring': highlite('a4c73c'),
    'comment': highlite('a6a6a6', 'italic'),
    'self': highlite('9c63a8', 'italic'),
    'numbers': highlite('636ba8'),
}
